...
import com.whx.notepen.Const.Broadcast;
import com.whx.notepen.Const.JsonTag;
...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSampleView.setPageSize(screenwidth, screenheight);
        ...
        mBuilder = new Builder(getApplicationContext());
